...
setup(
    ...
    install_requires=[
        ...
        "jupyter>=1.0.0",
        "py3Dmol>=1.8.0",
        # TODO: add conditinal dependancies, for example pip install pyrosetta_viewer3d[nglview]
        # "pyrosetta>=2022.21", #Pyrosetta is not on pip, so adding it as an explicit dependancy would only casue problems. 
    ],
    zip_safe=False,
)
